...
// Category data
const categories = [
  { label: "Men", to: "/products?category=men", emoji: "👔", bg: "bg-stone-100" },
  { label: "Women", to: "/products?category=women", emoji: "👗", bg: "bg-rose-50" },
  { label: "Bags", to: "/products?category=bags", emoji: "👜", bg: "bg-amber-50" },
  { label: "Beauty", to: "/products?category=beauty", emoji: "✨", bg: "bg-pink-50" },
  { label: "Electronics", to: "/products?category=electronics", emoji: "🎧", bg: "bg-blue-50" },
  { label: "Accessories", to: "/products?category=accessories", emoji: "💍", bg: "bg-purple-50" },
];

// Collage items using your actual local images
const collageItems = [
  { src: "/src/assets/women/shirts/shirts_1.jpg", span: "row-span-2", label: "New Season" },
  ...
  { src: "/src/assets/accessories/sunglasses/sunglasses_1.jpg", span: "", label: "Eyewear" },
];
    ...
    <div className="bg-[#f9f9f7]">
      ...
      <section className="relative h-[92vh] min-h-[600px] overflow-hidden bg-gray-900">
        ...
        <div className="relative h-full flex flex-col justify-end pb-20 px-8 md:px-16 lg:px-24 max-w-7xl">
          ...
          <p className="text-white/70 text-lg mb-8 max-w-md">
            Curated fashion for the modern individual. Discover pieces that define you.
          </p>
      ...
      <div className="bg-gray-900 text-white py-3 overflow-hidden">
        <div className="flex gap-12 animate-marquee whitespace-nowrap">
          {Array(6).fill(null).map((_, i) => (
            <span key={i} className="text-xs tracking-[0.3em] uppercase opacity-70">
              Free shipping over $100 &nbsp;·&nbsp; New arrivals weekly &nbsp;·&nbsp; Easy returns &nbsp;·&nbsp; Premium quality
            </span>
          ))}
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-xs tracking-[0.3em] text-gray-400 uppercase mb-2">Browse By</p>
            <h2 className="font-serif text-3xl md:text-4xl text-gray-900">Categories</h2>
          </div>
          <Link to="/products" className="text-sm text-gray-500 hover:text-gray-900 transition-colors underline underline-offset-4">
            View all
          </Link>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
          {categories.map((cat) => (
            ...
            >
              ...
              <span className="text-sm font-semibold text-gray-800 tracking-wide">{cat.label}</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-xs tracking-[0.3em] text-gray-400 uppercase mb-2">Editorial</p>
            <h2 className="font-serif text-3xl md:text-4xl text-gray-900">New Collection</h2>
          </div>
          <Link to="/products" className="text-sm text-gray-500 hover:text-gray-900 transition-colors underline underline-offset-4">
            Shop collection
          </Link>
